...
**Version 3.3.0** brings unified colored table headers across all pages, improved empty states with setup guides, library scans tracking in VODStreams, and enhanced localization support.
