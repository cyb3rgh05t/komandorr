    ...
    <div className="px-3 sm:px-4 py-4 sm:py-6 space-y-4 sm:space-y-6 pb-24">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        <aside className="lg:w-60 lg:shrink-0">
          <div className="bg-theme-card border border-theme rounded-xl p-2 lg:sticky lg:top-4">
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold transition-all whitespace-nowrap lg:w-full lg:justify-start ${
                      activeTab === tab.id
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              toast.error(
                                e.message || "Cannot connect to Plex",
                              );
                            }
                          }}
                          disabled={
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-theme-muted">
                    Select which Plex instance to use for VoD Plex-Sync
                    monitoring
                  </p>
                </div>
              </div>
                  ...
                  <div className="relative space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewPosterizarrName(e.target.value)
                          }
                          className="w-full px-4 py-2 bg-theme-hover backdrop-blur-sm border border-theme hover:border-theme-primary rounded-lg text-theme-text focus:ring-2 focus:ring-theme-primary focus:border-theme-primary transition-all"
                          placeholder="My Posterizarr"
                        />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewPosterizarrApiKey(e.target.value)
                        }
                        className="w-full px-4 py-2 bg-theme-hover backdrop-blur-sm border border-theme hover:border-theme-primary rounded-lg text-theme-text font-mono text-sm focus:ring-2 focus:ring-theme-primary focus:border-theme-primary transition-all"
                        placeholder="Paste your Posterizarr API key"
                      />
              ...
              <div className="flex items-center justify-between gap-3 mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-theme-muted">
                      Connect to one or more NFS Mount Manager instances for
                      NFS, MergerFS and VPN monitoring
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-theme-muted">
                      ...
                      triggers, queue and target monitoring (optional Basic
                      Auth).
                    </p>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewAutoscanUsername(e.target.value)
                          }
                          className="w-full px-4 py-2 bg-theme-hover backdrop-blur-sm border border-theme hover:border-theme-primary rounded-lg text-theme-text focus:ring-2 focus:ring-theme-primary focus:border-theme-primary transition-all"
                          placeholder="admin"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewAutoscanPassword(e.target.value)
                          }
                          className="w-full px-4 py-2 bg-theme-hover backdrop-blur-sm border border-theme hover:border-theme-primary rounded-lg text-theme-text font-mono text-sm focus:ring-2 focus:ring-theme-primary focus:border-theme-primary transition-all"
                          placeholder="Basic Auth password"
                        />
                ...
                >
                  ...
                  <div className="relative space-y-4">
                    ...
                    <p className="text-xs text-theme-muted">
                      ...
                      terminal, image, mail, message, git, box, layers, zap,
                      book, app — or paste an image URL / upload a custom icon
                    </p>
                    <div className="flex gap-2">
                      <button
                        type="button"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          <div className="sm:col-span-2">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setNewArrAccessUrl(e.target.value)
                              }
                              className="w-full px-4 py-2 bg-theme-hover backdrop-blur-sm border border-theme hover:border-theme-primary rounded-lg text-theme-text focus:ring-2 focus:ring-theme-primary focus:border-theme-primary transition-all"
                              placeholder="https://radarr.example.com"
                            />
