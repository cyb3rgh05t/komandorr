...
export default function Dashboard() {
  ...
  const [dashboardVisibility, setDashboardVisibility] = useState(() => {
    ...
    return {
      ...
      pageCharts: true,
      ...parsed,
      // Drop deprecated keys so old localStorage doesn't keep them around.
      services: undefined,
      vpnList: undefined,
    };
  });
    ...
    <DashboardLayoutProvider>
      <div className="px-3 sm:px-4 py-4 sm:py-6 space-y-4 sm:space-y-6 min-w-0 overflow-hidden">
        ...
        {vpnConnectionStatus?.connected && dashboardVisibility.vpnMap && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:items-stretch lg:h-[460px] 2xl:h-[500px]">
